...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        "     TexCoord1 = vTexCoord + offset1 * 0.00115;                                                                         \n"
      
        "     TexCoord2 = vTexCoord + offset2 * 0.00115;                                                                         \n"
       
        "     TexCoord3 = vTexCoord + offset3 * 0.00115;                                                                         \n"

        "     TexCoord4 = vTexCoord + offset4 * 0.00115;                                                                         \n"
...
"    originalPixel        =  originalPixel * NdotN1 + distance* 1000.0;                                                                                         \n"

"    highp float OCCLUSION = pow(inversesqrt(originalPixel.x), 1.0);                                                                             \n"
